...
public class PersonnageContrat extends PersonnageDecorator {
	...
	public void checkInvariant() {
		/*
		 * [invariants] min estVaincu(P) = pointsDeVie(P) â‰¤ 0
		 */
		if (estVaincu()) {
			if (pointsDeVie() > 0)
	...
	public void init(String nom, int largeur, int hauteur, int profondeur, int force, int pdv) {
...
**** estEquipe(init(n,l,h,p,f,pv)) = false
		 */
		if (!(nom().equals(nom) &&  largeur() == largeur && hauteur() == hauteur && profondeur() == profondeur
				&& force() == force && pointsDeVie() == pdv && sommeArgent() == 0 && estEquipe() == false)) {
...
* */
		if (!(pointsDeVie() == pdv_atpre - s && sommeArgent() == argent_atpre && estEquipe() == equipe_atpre && laChoseEquipee() == chose_atpre))
...
* */
		if (!(pointsDeVie() == pdv_atpre && sommeArgent() == argent_atpre - s && estEquipe() == equipe_atpre && laChoseEquipee() == chose_atpre))
...
* */
		if (!(pointsDeVie() == pdv_atpre && sommeArgent() == argent_atpre && estEquipe() == true && laChoseEquipee() == o))
